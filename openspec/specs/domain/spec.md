...
## Purpose
Define the baseline domain package structure for core business concepts, including the initial item hierarchy and the first order aggregate outside the UI package area.
