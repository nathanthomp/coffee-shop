...
## Purpose
Define project-wide coding conventions for Java source so declarations communicate visibility, modifier intent, and lightweight design expectations consistently across the codebase.
